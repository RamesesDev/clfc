            ...
            <table width="100%">
                <tr>
                    <td width ="50%" valign="top">
                        <% data.principalOtherSourcesOfIncomeList.each { otherIncome -> %>
                            <div align="center"><h2>${otherIncome.kindOfBusiness}</h2></div>
                            <table>
                                <tr><td><b>Gross Net/Income :</b></td>
                                    <td><b>Php</b>
                                        <b class="green">${format(otherIncome.grossNetIncome)}</b>
                                    </td>
                                </tr>
                                <tr><td><b>Remarks :</b></td><td> ${otherIncome.remarks.toUpperCase()}</td></tr>
                            </table>
                            <br><hr><br>
                       <% } %>
                    </td>
