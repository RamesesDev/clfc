...
public class CrecomRecommendationForm extends javax.swing.JPanel {
    
    public CrecomRecommendationForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xTextArea1.setCaption("Crecom Recommendation");
        xTextArea1.setHint("Write your recommendation here.");
        xTextArea1.setName("crecomrecommendation");
        xTextArea1.setRequired(true);
        xTextArea1.setShowCaption(false);
        jScrollPane1.setViewportView(xTextArea1);

        xLabel1.setText("<html><b>Crecom Recommendation: </b></html>");
