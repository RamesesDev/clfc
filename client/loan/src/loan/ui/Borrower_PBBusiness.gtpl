...
<html>
    ...
    <body>
        <% if(!data.principalMainBusinessList) { %>
            ...
            <table width="100%">
                ...
                <tr>
                    <td width ="50%" valign="top">
                        <% data.principalMainBusinessList.each { business -> %>
                            ...
                            <table>
                                    ...
                                    <tr>
                                        <%if ( business.occupancy.type=="OWNED" ) {%>
                                            <td valign="top"><td><b class="info">Type :</b> <b class="info2">${business.occupancy.type? business.occupancy.type: '-'}</b><br>
                                                ...
                                                <b class="info">Since :</b> <b class="info2">${formatDate(business.occupancy.since)}</b>
                                            </td>
                                        <%}%>
                                ...
                                <tr><td><b>Business Hours :</b> </td>
                                    <td>
                                        ${business.businessHours.businessHoursFrom? business.businessHours.businessHoursFrom: '-'} 
                                        - ${business.businessHours.businessHoursTo? business.businessHours.businessHoursTo: '-'}
                                    </td>
                                </tr>        
                                <tr><td><b>Days Open :</b></td><td> ${business.businessHours.daysOpen}</td></tr>
                                <tr>
                            ...
                            <%if(data.principalMainBusinessList.size() >0 ) {%>
                                <hr>
                            <%}%>
                        <%}%>
                    </td>    
