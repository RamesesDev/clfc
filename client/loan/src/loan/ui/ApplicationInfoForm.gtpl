        ...
        <div class="info">
            <table>
                ...
                <%if ( data.state=="FOR_INSPECTION" ) {%>
                    <tr>
                        <th>Status : </th>
                        <%if ( !data.dtsubmittedforci ) {%>
                            <td><b class="gray">${data.state}</b></td>
                        <%}%>
                        <%if ( data.dtsubmittedforci ) {%>
                            <td><b class="gray">${data.state}</b>
                                on <b class="teal">${formatDate2(data.dtsubmittedforci)}</b>
                            </td>
                        <%}%>
                    </tr>
                <%}%>
                <%if ( data.state=="FOR_FLA" ) {%>
                    <%if ( !data.resenddate ) {%>
                        <th>Status : </th>
                        <%if ( !data.dtsubmittedforfla ) {%>
                            <td><b class="gray">${data.state}</b></td>
                        <%}%>
                        <%if ( data.dtsubmittedforfla ) {%>
                            <td><b class="gray">${data.state}</b>
                                on <b class="green">${formatDate2( data.dtsubmittedforfla )}</b>
                            </td>
                        <%}%>
                    <%}%>
                    <%if ( data.resenddate ) {%>
                ...
                <%if ( data.state=="FOR_RELEASE" ) {%>
                    <tr>
                        ...
                        <td>
                            <b class="navy">${data.state}</b>
                            <%if ( data.dtsubmittedforreleasedate ) {%>
                                on <b class="green">${formatDate2(data.dtsubmittedforreleasedate)}</b>
                            <%}%>
                        </td>
                    </tr>
                <%}%>
                <%if ( data.state=="RELEASED" ) {%>
                    <tr>
                        <th>Status : </th>
                        <td>
                            <b class="green">${data.state}</b>
                                on <b class="green">${formatDate2(data.dtreleased)}</b>
                        </td>
                    </tr>    
                <%}%>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </b><b>CI:</b> <b class="teal"><u>${format(data.ciRecomAmt)}</u></b>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </b><b>FCA:</b> <b class="teal"><u>${format(data.fcaRecomAmt)}</u></b>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </b><b>CAO:</b> <b class="teal"><u>${format(data.caoRecomAmt)}</u></b>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </b><b>BCOH:</b> <b class="teal"><u>${format(data.bcohRecomAmt)}</u></b>
                                </td>
                            </tr>
                        </table>
                    </div><br>
