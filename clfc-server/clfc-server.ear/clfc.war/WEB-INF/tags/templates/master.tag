	...
	<body style="margin:0; font-family:Arial;">
		<table width="100%" height="100%" cellpadding="0" cellspacing="0" >
			<tr>
				...
				<td class="header" id="middle-width" height="10px">
			...
			<tr>
				<td>&nbsp;</td>
				<td id="middle-width" valign="top" style="padding-top:5px;padding-bottom:10px;">
					<jsp:doBody/>
				</td>
				<td>&nbsp;</td>
			</tr>
			<tr >
				...
				<td class="footer" id="middle-width" height="10px">
