...
<i class="maroon" context="loan" visibleWhen="#{!selected.propertylist.length}"> No property specified.</i>
<j context="loan" visibleWhen="#{!selected.propertylist}">
    <br/><br/>
</j><br/>
<label context="loan" visibleWhen="#{!selected.propertylist.length && 
	!selected.appliancelist.length && !selected.vehiclelist.length}">
	<i class="maroon">No Collateral Specified.</i><br/>
</label>
<b class="maroon"  context="loan" visibleWhen="#{!appraisedvalue}">Property/Properties</b> 
...
<j context="loan" visibleWhen="#{selected.appliancelist.length >0}">
    <b class="maroon"  context="loan" visibleWhen="#{!appraisedvalue}">Appliance(s)</b> 
        <j context="loan" visibleWhen="#{!appraisedvalue}"> ( Total Appraised =</j> <b context="loan" visibleWhen="#{!appraisedvalue}">Php</b>
        <j class="teal2" context="loan" visibleWhen="#{!appraisedvalue}"> 0.00</j> <j  context="loan" visibleWhen="#{!appraisedvalue}">)</j>    
    <br/>    
	<b class="maroon" context="loan" visibleWhen="#{appraisedvalue}">Appliance(s)</b> 
...
<i class="maroon" context="loan" visibleWhen="#{!selected.vehiclelist.length}"> No Vehicle specified.</i>
<j context="loan" visibleWhen="#{!selected.vehiclelist}">
    <br/><br/>
</j>
<b class="maroon"  context="loan" visibleWhen="#{!appraisedvalue}">Vehicle(s)</b> 
       <j context="loan" visibleWhen="#{!appraisedvalue}">
        ( Total Appraised =</j> <b context="loan" visibleWhen="#{!appraisedvalue}">Php</b>
        <j class="teal2" context="loan" visibleWhen="#{!appraisedvalue}">
         0.00</j> <j  context="loan" visibleWhen="#{!appraisedvalue}">)</j>
    <br/>
<b class="maroon" context="loan" visibleWhen="#{appraisedvalue}">Vehicle(s)</b> 
	   <j context="loan" visibleWhen="#{appraisedvalue}">
	    ( Total Appraised = </j><b context="loan" visibleWhen="#{appraisedvalue}">Php</b> 
	     <b class="teal" context="loan" visibleWhen="#{appraisedvalue}"> 
	     <label context="loan" visibleWhen="#{appraisedvalue}">
	     #{appraisedvalue.formatDecimal()}</label></b> <j  context="loan" visibleWhen="#{appraisedvalue}">)</j>
...
<div class="tab-content">
	<table>
		<td>
			...
			<div context="loan"  style="float: left" visibleWhen="#{commentTab == 'crecomrecommendation'}">
				<div  context="loan"  visibleWhen="#{selected.state == 'FOR_APPROVAL'}">
				    <div context="loan" visibleWhen="#{!selected.crecomrecommendation}">
					    <i class="maroon">No Crecom Recommendations yet.</i>
				    </div>
				    <div>
				        <div context="loan" style="float: left"><!--width="220px" style="padding-left: 5px;"-->
					        <fieldset> <!-- style="padding-right:0px"-->
						            <legend class="green"><h4><b>FLA DECISIONS</b></h4></legend>
						            <ul>
							            <li>
				        ...
				        <div context="loan" style="float: right">
                                <fieldset>
				                    <legend class="green"><h4><b>OTHER RECOMMENDATIONS</h4></b></legend>
                                    <div align="right">
				                        <j context="loan" visibleWhen="#{selected.marketerRecomAmt || 
				                            selected.ciRecomAmt || selected.caoRecomAmt || selected.fcaRecomAmt || selected.bcohRecomAmt}">
					                        ...
					                        <label context="loan" visibleWhen="#{selected.marketerRecomAmt}">
						                        <b class="dKhaki">
							                        <b class="black">Php</b> <b class="maroon">#{selected.marketerRecomAmt.formatDecimal()}</b>
						                        </b>
					                        </label>
					                        <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					                        ...
					                        <b context="loan" visibleWhen="#{selected.ciRecomAmt}">CI :</b>
					                        <label context="loan" visibleWhen="#{selected.ciRecomAmt}">
						                        <b class="black">Php</b> <b class="maroon">#{selected.ciRecomAmt.formatDecimal()}</b>
					                        </b></label>
					                        <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					                        ...
					                        <b context="loan" visibleWhen="#{selected.fcaRecomAmt}">FCA :</b>
					                        <label context="loan" visibleWhen="#{selected.fcaRecomAmt}">
						                        <b class="black">Php</b> <b class="maroon">#{selected.fcaRecomAmt.formatDecimal()}</b>
					                        </b></label>
					                        <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					                        ...
					                        <b context="loan" visibleWhen="#{selected.caoRecomAmt}">CAO :</b>
					                        <label context="loan" visibleWhen="#{selected.caoRecomAmt}">
						                        <b class="black">Php</b> <b class="maroon">#{selected.caoRecomAmt.formatDecimal()}</b>
					                        </b></label>
					                        <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					                        ...
					                        <b context="loan" visibleWhen="#{selected.bcohRecomAmt}">BCOH :</b>
					                        <label context="loan" visibleWhen="#{selected.bcohRecomAmt}"><b class="dKhaki">
						                        <b class="black">Php</b> <b class="maroon">#{selected.bcohRecomAmt.formatDecimal()}</b>
					                        </b></label>
				                        </j>
				                    </div>
				                </fieldset>
				 ...
				 <div context="loan" width="100%">
				        <span context="loan" style="float: center">
				            <div class="sender">
			...
			<div context="loan" visibleWhen="#{commentTab == 'prevfla'}">
				...
				<div context="loan" visibleWhen="#{selected.prevFLA}">
					...
					<fieldset>
							...
							<div class="sender">
								<label context="loan">
									posted by #{selected.prevFLA.approvalAnnotation.author? selected.prevFLA.approvalAnnotation.author : ' - '} @ 
					...
					<div context="loan" visibleWhen="#{selected.prevFLA.loanOffer}" style="padding: 10px 0px;">
						<fieldset>
							...
							<div class="sender">
								<label context="loan">
									posted by #{selected.prevFLA.offeralAnnotation.author? selected.prevFLA.offeralAnnotation.author : ' - '} @ 
