...
@StyleSheet
public class DefaultAddressControl extends javax.swing.JPanel {
    
    /** Creates new form OpenerQueuePage */
    public DefaultAddressControl() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xTextField6.setCaption("Country");
        xTextField6.setHint("Country");
        xTextField6.setName("context.country");
        xTextField6.setRequired(true);
        xTextField6.setShowCaption(false);
        xTextField6.setToolTipText("Country");
        ...
        add(xTextField6);
        xTextField6.setBounds(254, 40, 62, 19);
